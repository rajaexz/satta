...
class MakeBitPageScreen extends StatelessWidget {
  ...
  //   print("-------------------${controller.selectedDigit!.value.toString()}");
  //   // Check if the required fields are not empty
  //   if ( controller.pointController.text.isEmpty) {
  ...
  //         "bid_points":  controller.pointController.text,
  //         "open_digit":  controller.selectedDigit!.value.toString(),
  //         "close_digit": "",
  //         "open_panna": "",
  //         "close_panna": ""
  //       });
  ...
  //    controller.pointController.clear();
  // }
            ...
            children: [
              Expanded(
                ...
                child: Obx(() => DropDownField(
                    ...
                    value:controller.selectedDigit!.value,
                    required: true,
                    strict: true,

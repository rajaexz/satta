      ...
      children: [
        Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                fontSize: 11,
                color: isActive ? myColorWhite : myColorGray,
              ),
            )),
        Row(
          ...
          children: [
            AnimatedContainer(
              ...
              child: num == 0
                  ? Icon(Icons.star,
                      size: isActive ? 15.0 : 10.0, color: myColor)
                  : num == 1
                      ? Icon(Icons.group_add,
                          size: isActive ? 11.0 : 10.0, color: myColor)
                      : num == 2
                          ? Icon(Icons.check_circle,
                              size: isActive ? 13.0 : 10.0, color: myColor)
                          : Icon(
                              Icons.error), // Default icon for unknown status
